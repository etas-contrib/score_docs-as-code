...
.. tool_req:: Enforces presence of description
  ...
  :implemented: YES
  :satisfies:
    gd_req__req_attr_description[version==1],
    gd_req__req_check_mandatory[version==1],
    gd_req__sec_argument[version==1],
    gd_req__impl_diagram_description[version==1],
    gd_req__impl_unit_description[version==1],
    gd_req__impl_interface_description[version==1]
...
.. tool_req:: Document Types
  ...
  * Change Request is also a generic document
  ...
  .. note:: Only QM as not providing types cannot be harmful.
...
.. tool_req:: Support requirements test coverage
  ...
  :version: 1
  :parent_covered: YES
  :satisfies: gd_req__req_attr_test_covered[version==1]
  :status: invalid
...
.. tool_req:: Enforce validity start is before end
  ...
  .. note:: Only QM as an invalid range cannot be harmful.
...
.. tool_req:: Architecture Types
  ...
  :version: 1
  :satisfies:
     gd_req__arch_hierarchical_structure[version==1],
     gd_req__arch_build_blocks[version==1],
  :implemented: YES
  :parent_covered: YES
  ...
  * Interface Operation (real_arc_int_op)
  ...
  .. note:: Only QM because not providing types cannot be harmful.
...
.. tool_req:: Architecture Mandatory Attributes
   ...
   :version: 2
   :satisfies:
      gd_req__arch_attr_mandatory[version==1],
...
.. tool_req:: Support Diagram drawing of architecture
  ...
  :version: 1
  :satisfies:
    gd_req__arch_viewpoints[version==1]
  :parent_covered: YES
...
.. tool_req:: Architecture diagram links
  ...
  .. note:: Only QM because architecture diagrams get manually reviewed anyways.
...
.. tool_req:: Supports linking to source code
  ...
  :parent_covered: YES
  :satisfies:
    gd_req__req_attr_impl[version==1]
  ...
  .. note:: Only QM because these links are only for convenience.
...
.. tool_req:: Feature Flags
   ...
   :implemented: NO
   :parent_covered: YES
   :satisfies: gd_req__req_linkage_architecture_switch[version==1]
...
.. tool_req:: Supports linking to test cases
  ...
  :implemented: YES
  :parent_covered: YES
  :satisfies: gd_req__req_attr_testlink[version==1]
...
.. tool_req:: Extract Metadata from Tests
   ...
   .. note:: Only QM because missing these attributes is not critical.
...
.. tool_req:: Extract Metadata from Tests
   ...
   .. note:: this will probably be implemented outside of docs-as-code.
      ...
      Only QM because missing a test description is not critical.
...
.. tool_req:: Enforce security classification
  ...
  :version: 1
  :parent_covered: YES
  :satisfies: gd_req__tool_attr_security_affected[version==1], gd_req__tool_check_mandatory[version==1]
...
.. tool_req:: Enforce status classification
  ...
  :implemented: YES
  :version: 1
  :satisfies: gd_req__tool_attr_status[version==1], gd_req__tool_check_mandatory[version==1]
  :parent_covered: YES
...
.. tool_req:: Enforce version attribute
  ...
  :implemented: YES
  :version: 2
  :satisfies: gd_req__tool_attr_version[version==1]
  :parent_covered: YES
...
.. tool_req:: Workflow Types
  ...
  :implemented: YES
  :version: 1
  :satisfies: gd_req__process_management_build_blocks_attr[version==1], gd_req__process_management_build_blocks_link[version==1]
...
.. tool_req:: Safety Analysis Need Types
  ...
  :version: 2
  :satisfies:
    gd_req__saf_structure[version==1],
    gd_req__saf_attr_uid[version==1],
  :parent_covered: YES
  ...
  * Component DFA (Dependent Failure Analysis) -> ``comp_saf_dfa``
  ...
  .. note:: Only QM because lacking these types cannot be harmful.
...
.. tool_req:: Safety Analysis Mandatory Attributes
  ...
  :version: 1
  :satisfies:
    gd_req__saf_attr_mandatory[version==1],
    gd_req__sec_attr_mandatory[version==1],
  :parent_covered: YES
...
.. tool_req:: Safety Analysis Mitigation Attribute
  ...
  :version: 1
  :satisfies:
    gd_req__saf_attr_mitigated_by[version==1],
    gd_req__saf_attr_requirements[version==1],
    gd_req__saf_attr_requirements_check[version==1],
    gd_req__saf_attr_aou[version==1],
    gd_req__saf_linkage_safety[version==1],
    gd_req__sec_attr_mitigated_by[version==1],
    gd_req__sec_attr_requirements_check[version==1],
  :parent_covered: YES
...
.. tool_req:: Safety Analysis Mitigation Issue Attribute
  ...
  :tags: Safety Analysis
  :version: 1
  :satisfies: gd_req__saf_attr_mitigation_issue[version==1]
...
.. tool_req:: Safety Analysis Sufficient Attribute
  ...
  * no
  ...
  .. note:: Only QM because missing this attribute cannot be harmful.
...
.. tool_req:: Security Analysis Need Types
  ...
  :version: 2
  :satisfies:
   gd_req__sec_structure[version==1]
  :parent_covered: NO: Process requirements are not yet fully done
...
.. tool_req:: Security Analysis: STRIDE Threat ID Attribute
  ...
  :tags: Security Analysis
  :version: 1
  :satisfies: gd_req__sec_attr_stride_threat_id[version==1]
  :parent_covered: YES
...
.. tool_req:: Security Analysis Threat Scenario Mandatory Attributes
  ...
  :version: 1
  :satisfies:
    gd_req__sec_attr_threat_scenario_id[version==1],
    gd_req__sec_attr_status[version==1],
    gd_req__sec_attr_sufficient[version==1],
    gd_req__sec_attr_teffect[version==1]
  :parent_covered: YES
...
.. tool_req:: Security Analysis Optional Attributes
  ...
  :version: 1
  :satisfies:
    gd_req__sec_attr_mitigation_issue[version==1],
    gd_req__sec_attr_aou[version==1],
  :parent_covered: YES
