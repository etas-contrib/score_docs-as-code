...
def sphinx_app_setup(
    ...
    def _create_app():
        ...
        return SphinxTestApp(
            ...
            buildername="html",
            warningiserror=True,
            # Source links are generated before Sphinx starts; the docs CLI
            # passes the resolved path via ``--define``, matching the Bazel
            # build contract used by the extension in production.
            confoverrides={
...
def test_source_link_integration_ok(
    ...
    try:
        ...
        for i in (1, 2, 3):
            ...
            # verify codelinks (compare as sets since order may vary)
            ...
            assert expected_links == actual_links, treq_id
